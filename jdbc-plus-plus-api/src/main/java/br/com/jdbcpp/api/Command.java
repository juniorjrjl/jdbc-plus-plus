...
public @interface Command {
    ...
    /**
     * The name of the auto-generated primary key column
     * (only INSERT operations and methods with PK type return).
     * note: PostgreSQL work only with name configuration
     * @return the name of the auto-generated primary key column
     */
    String autoGeneratedPKNameOrIndex() default "";
