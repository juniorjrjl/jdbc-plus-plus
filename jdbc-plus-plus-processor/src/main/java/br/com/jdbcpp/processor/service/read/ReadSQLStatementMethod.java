package br.com.jdbcpp.processor.service.read;
...
public abstract class ReadSQLStatementMethod<T extends MethodInfo> {
    ...
    public MethodSpec.Builder build(final T methodInfo, final String connectionCall){
        ...
        buildResultSetRead(methodInfo, methodBuilder, statementVar);
    ...
    protected abstract void buildResultSetRead(final T methodInfo,
