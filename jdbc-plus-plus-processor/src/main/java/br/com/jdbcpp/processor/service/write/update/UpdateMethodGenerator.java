...
public class UpdateMethodGenerator extends WriteSQLStatementMethod<UpdateMethod> {

    @Override
    protected MethodSpec.Builder buildBaseBody(final UpdateMethod methodInfo,
